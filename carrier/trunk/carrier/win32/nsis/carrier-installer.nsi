...
;Modern UI Configuration
  ...
  !define MUI_FINISHPAGE_LINK			$(PIDGINFINISHVISITWEB_SITE)
...
Section $(PIDGINSECTIONTITLE) SecPidgin
  ...
  carrier_hkcu:
    ...
    WriteRegStr HKCU "${PIDGIN_UNINSTALL_KEY}" "DisplayIcon" "$INSTDIR\carrier.exe"
...
SectionGroup $(TRANSLATIONSSECTIONTITLE) SecTranslations
  ...
  !include "carrier-translations.nsh"
SectionGroupEnd
${MementoSectionDone}
...
SectionGroup $(PIDGINSPELLCHECKSECTIONTITLE) SecSpellCheck
  !include "carrier-spellcheck.nsh"
SectionGroupEnd
...
!ifdef OFFLINE_INSTALLER
  ...
  SetOutPath $PLUGINSDIR
  File /oname=dbgsym.zip "..\..\..\carrier-${PIDGIN_VERSION}-dbgsym.zip"
...
Function SelectAndDisableInstalledDictionaries
  ...
  !include "carrier-spellcheck-preselect.nsh"
