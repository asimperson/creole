...
%if 0%{?beta}
%define carrierver %(echo "2.4.3"|sed -e 's/dev.*//; s/beta.*//')
%else
%define carrierver 2.4.3
%endif
...
%package devel
Summary:    Development headers, documentation, and libraries for Carrier
Group:      Applications/Internet
Requires:   carrier = %{version}, libpurple-devel = %{version}
Requires:   gtk2-devel
Requires:   pkgconfig
...
Summary:    Bonjour plugin for Carrier
Group:      Applications/Internet
...
Summary:    Lotus Sametime plugin for Carrier using the Meanwhile library
Group:      Applications/Internet
Requires:   libpurple >= %{apiver}
%endif
...
Summary:    Mono .NET plugin support for Carrier
Group:      Applications/Internet
Requires:   libpurple >= %{apiver}
%endif
...
%package -n finch
Summary:    A text-based user interface for Carrier
Group:      Applications/Internet
Requires:   libpurple = %{version}
...
%description
Carrier allows you to talk to anyone using a variety of messaging
...
Carrier supports many common features of other clients, as well as many
unique features, such as perl scripting, TCL scripting and C plugins.

Carrier is not affiliated with or endorsed by America Online, Inc.,
Microsoft Corporation, Yahoo! Inc., or ICQ Inc.

%description devel
The carrier-devel package contains the header files, developer
documentation, and libraries required for development of Carrier scripts
and plugins.
...
Bonjour plugin for Carrier.
%endif

%if 0%{?_with_meanwhile:1}
%description -n libpurple-meanwhile
Lotus Sametime plugin for Carrier using the Meanwhile library.
%endif

%if 0%{?_with_mono:1}
%description -n libpurple-mono
Mono plugin loader for Carrier.  This package will allow you to write or
use Carrier plugins written in the .NET programming language.
%endif
...
%files devel
%defattr(-, root, root)
%dir %{_includedir}/carrier
%{_includedir}/carrier/*.h
%{_libdir}/pkgconfig/carrier.pc
