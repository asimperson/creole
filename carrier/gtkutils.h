...
/**
 * Places the status icon over the protocol icon like Gaim did.
 *
 * @param prpl_pixbuf	The protocol icon.
 * @param status_bixbuf	The status icon.
 *
 * @return A pixbuf that has the status icon near the bottom of
 *	   the protocol icon.
 */
GdkPixbuf *funpidgin_overlay(GdkPixbuf *prpl_pixbuf, GdkPixbuf *status_pixbuf);
