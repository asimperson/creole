...
GdkPixbuf *
funpidgin_overlay(GdkPixbuf *prpl_pixbuf, GdkPixbuf *status_pixbuf)
{
	int width, height, emblem_width, emblem_height;
	int new_emblem_width, new_emblem_height;

	width = gdk_pixbuf_get_width(prpl_pixbuf);
	height = gdk_pixbuf_get_height(prpl_pixbuf);
	emblem_width = gdk_pixbuf_get_width(status_pixbuf);
	emblem_height = gdk_pixbuf_get_height(status_pixbuf);
	/*
	...
	*/
	...
	gdk_pixbuf_composite(status_pixbuf, prpl_pixbuf,
